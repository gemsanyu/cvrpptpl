...
def prepare_l2_destroy_operators():
    from heuristic.l2_destroy_operator import RandomMrtLineRemoval, WorstLockersRemoval, RandomCustomersRemoval, RandomLockersRemoval, WorstCustomersRemoval
    op1 = WorstLockersRemoval(1,3)
    op2 = RandomCustomersRemoval(1,5)
    op3 = RandomLockersRemoval(1,3)
    op4 = WorstCustomersRemoval(1,5)
    op5 = RandomMrtLineRemoval(1,1)
